(() => {
  ...
  const translations = {
    ar: {
      ...
      pageDescription: 'حازم موسى — خبرة عملية في شئون العاملين والمرتبات وقانون العمل، مع تدريب وأدوات HR تساعدك في عملك اليومي.',
      ...
      heroLead: 'أساعد الأفراد والشركات في تطوير ممارسات الموارد البشرية وشئون العاملين والمرتبات من خلال أدوات عملية، محتوى متخصص، وتدريب مبني على خبرة حقيقية في سوق العمل المصري.',
      ...
      spotlightTitle: 'جانب من الرحلة المهنية',
      spotlightDesc: 'ظهور مهني يسلّط الضوء على الخبرة في إدارة الموارد البشرية وشئون العاملين والمرتبات، ضمن رحلة تجمع بين الإدارة والتدريب وتطوير أدوات عملية لمجتمع الـHR.',
      readJourney: 'تعرّف على الرحلة',
      expertiseTitle: 'خبرة تربط القانون بالتطبيق',
      expertiseLead: 'المحتوى والتدريب والأدوات مبنية على احتياجات العمل اليومية داخل إدارات الموارد البشرية.',
      expert1Title: 'شئون العاملين',
      expert1Desc: 'الملفات والعقود واللوائح والسجلات والإجراءات والامتثال.',
      expert2Desc: 'الاستحقاقات والاستقطاعات وربط العمليات بالبيانات.',
      expert3Title: 'قانون العمل',
      expert3Desc: 'فهم النص القانوني وتطبيقه على مواقف HR اليومية.',
      expert4Title: 'التدريب والتطوير',
      expert4Desc: 'برامج عملية تنقل المعرفة إلى مهارة قابلة للتطبيق.',
    ...
    en: {
      ...
      pageDescription: 'Hazem Moussa — practical experience in personnel, payroll, labor law, HR training and useful digital tools.',
      ...
      navKnowledge: 'Training & Knowledge',
      navAbout: 'About',
      navContact: 'Contact',
      ...
      heroLead: 'I help individuals and organizations improve HR, personnel and payroll practices through practical tools, specialized content and training grounded in real experience in the Egyptian labor market.',
      ...
      toolsEyebrow: 'Practical HR tools',
      ...
      spotlightTitle: 'A highlight from the professional journey',
      spotlightDesc: 'A professional feature highlighting experience in HR management, personnel and payroll—part of a journey combining management, training and practical tools for the HR community.',
      readJourney: 'Discover the journey',
      expertiseTitle: 'Experience connecting law with practice',
      expertiseLead: 'The content, training and tools are built around the everyday needs of HR teams.',
      expert1Title: 'Personnel Affairs',
      expert1Desc: 'Employee files, contracts, policies, records, procedures and compliance.',
      expert2Desc: 'Earnings, deductions and data-driven payroll operations.',
      expert3Title: 'Labor Law',
      expert3Desc: 'Understanding legal text and applying it to everyday HR scenarios.',
      expert4Title: 'Training & Development',
      expert4Desc: 'Practical programs that turn knowledge into applicable skills.',
